...
const ConfirmRide = (props) => {
  return (
    <div>
      <h5 onClick={()=>{props.setConfirmRidePanel(false)}} className='p-1 text-center absolute w-[93%] top-0 '><i className="text-3xl text-gray-200 ri-arrow-down-wide-line"></i></h5>
     ...
     <img className='h-20' src='https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_956,h_538/v1568134115/assets/6d/354919-18b0-45d0-a151-501ab4c4b114/original/XL.png'/>
            ...
            <button className='w-full mt-5 bg-green-400 text-white font-semibold p-2 rounded-lg' onClick={()=>{
            {props.setVehicleFound(true)
            props.setConfirmRidePanel(false)}}}>Confirm</button>
     </div>
    </div>
  )
}
